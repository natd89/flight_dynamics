  ...
  if (t==0) || flag_new_waypoints,
    ...
    switch 2,
          case 1,
            ...
            wpp = [...
                   0, 0, -100, -9999, P.va0;...
                    2000, 0, -100, -9999, P.va0;...
                    0, 2000, -100, -9999, P.va0;...
                    2000, 2000, -100, -9999, P.va0;...
                  ];
          case 2,  % Dubins
            num_waypoints = 4;
            wpp = [...
                    0, 0, -100, 0, P.va0;...
                    1500, 0, -100, 45*pi/180, P.va0;...
                    0, 1500, -100, 45*pi/180, P.va0;...
                    1500, 1500, -100, -135*pi/180, P.va0;...
                  ];
          case 3,  % path through city using Dubin's paths
              ...
              waypoints = planRRTDubins(wpp_start, wpp_end, P.R_min, map, P);
